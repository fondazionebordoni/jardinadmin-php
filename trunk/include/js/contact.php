...
<head>
	...
	<title>Simple jQuery Ajax Loading</title>
	<link href="style.css" rel="stylesheet" type="text/css" media="screen" />
	<script type="text/javascript" src="js/jquery/jquery.js"></script>
	<script type="text/javascript" src="js/jquery/jquery.main.js"></script>
</head>
<body>
<div id="wrapper">
	<div id="header-wrapper">
		<div id="header">
			<div id="logo">
				<h1><a href="#">Simple jQuery Ajax Loading</a></h1>
				<h2>by <a href="http://www.simonedamico.it/">Simone D'Amico</a></h2>
			</div>
			<div id="search">
			...
			<div  id="bgcontent">
				<div id="content">
					<div class="post">
						...
						<?php
							echo "Questo codice è generato in PHP per dimostrare il corretto funzionamento anche con pagine contenenti script." . 
								 "In questo momento sono le ore " . date("H:i") . " del giorno " . date("d-m-Y") . ".";
						?>
